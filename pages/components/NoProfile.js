...
function Profile(props) {
    ...
    return (
        <Link href={server + "people/" + props.Name} passHref>
            ...
            <button className="text-greenFont flex items-center justify-center mx-2 my-2 bg-whiteBackground rounded-lg flex items-center justify-center text-2xl font-mono h-5/6 border-2 border-greenBackground">
                <div>
                    <div>
                        <div>
                            {props.Name}
